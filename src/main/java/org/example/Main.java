...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(repo.getPersonByIdList("1"));
        System.out.println(repo.getPersonByIdList("2"));
        System.out.println(repo.getPersonByIdMap("3"));
        System.out.println(repo.getPersonByIdList("4"));
        System.out.println(repo.getPersonByIdMap("4"));
        System.out.println("============= Get Weekday Method =======================");
        System.out.println(repo.getPersonByIdMap("1").get().favoriteDay().weekDayAsString());
        System.out.println(repo.getPersonByIdMap("2").get().favoriteDay().weekDayAsString());
        System.out.println(repo.getPersonByIdMap("3").get().favoriteDay().weekDayAsString());
